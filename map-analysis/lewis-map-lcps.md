...
The LCPs that overlap with his roads show that the Roman took into consideration the landscape while constructing these roads keeping in mind future uses for those roads. The primary function when they were first constructed was for the military so they could traverse the landscape and move armies with ease. However they must've thought of future uses for these roads, and constructed them so that they could have the most optimal paths between points of importance like future settlements. Then to secure these paths, there was cultural influence which defended small towns to create a secure and cost efficient network of roads for transferring information.
