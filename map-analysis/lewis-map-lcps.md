...
|:-------------------------:|:-------------------------:|:-------------------------:|
| <a href="{% link map-analysis/lewis-map-dur-leto.md %}"><img width="1604" alt="photo" src="maps/lewis-duro-letoc-w-roads.png"> </a> Paths from Durovigutum to Letocetum | <a href="{% link map-analysis/lewis-map-duro-ship.md %}"><img width="1604" alt="photo" src="maps/lewis-duro-ship-w-roads.png"> <a/> Paths from Durovigutum to Shiptonthrope | <a href="{% link map-analysis/lewis-map-duro-uxe.md %}"><img width="1604" alt="photo" src="maps/lewis-duro-uxelodum-w-roads.png"> </a> Paths from Durovigutum to Uxelodum |
